...
public class OrderRestController {
    ...
    private CostumerRestClientService customerRestClientService;
    private InventoryRestClientService inventoryRestClientService;

    public OrderRestController(OrderRepository orderRepository, ProductItemRepository productItemRepository, CostumerRestClientService customerRestClientService, InventoryRestClientService inventoryRestClientService) {
    ...
    public Order getOrder(@PathVariable Long id) {
        ...
        Costumer customer = customerRestClientService.customerById(order.getCustomerId());
